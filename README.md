...
Searchable, timestamped transcripts of **162 regular YouTube uploads by RamyAura**, covering **73.05 hours** of Teemo gameplay and discussion. Shared free of charge with RamyAura's permission; his agreement to sharing is conditional on it being free.
...
The collection contains 161 videos with detected speech and one guide presented as on-screen text. The latter has a separately labelled OCR transcript. Livestreams and Shorts are outside this snapshot. Collection last updated on **2026-09-23**, including regular uploads published through **2026-09-22**. New regular uploads are checked daily at 06:00 Europe/London; see [Automation](AUTOMATION.md).
...
The spoken material is transcribed with OpenAI `gpt-transcribe`. Daily additions apply conservative spelling rules and carry an explicit automated-review flag; ambiguous names and matchups require further review. The reading layer includes **1,659 traceable terminology corrections across 1,187 passages**, including champion names, player names, items and the cheater recall concept. Original GPT wording and the exact correction spans are retained so readers can inspect those decisions. 33 detected terminology questions remain unresolved and are flagged; that count is not a claim that no other errors remain.
